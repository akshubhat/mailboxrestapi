...
$app->get('/messages', 'authenticate', function() {
            ...
            $result = $db->getAllUsermessages($user_id);
            ...
            while ($message = $result->fetch_assoc()) {
                ...
                $tmp["createdAt"] = $message["created_at"];
 ...
 */
$app->get('/messages/:id', 'authenticate', function($message_id) {
            global $user_id;
            $response = array();
            $db = new DbHandler();

            // fetch message
            $result = $db->getmessage($message_id, $user_id);
...
$app->post('/messages', 'authenticate', function() use ($app) {
            ...
            $message_id = $db->createmessage($user_id, $message);
 ...
 * url - /messages/:id
 */
$app->put('/messages/:id', 'authenticate', function($message_id) use($app) {
            // check for required params
            verifyRequiredParams(array('message', 'status'));
            ...
            // updating message
            $result = $db->updatemessage($user_id, $message_id, $message, $status);
            if ($result) {
 ...
 * url /messages
 */
$app->delete('/messages/:id', 'authenticate', function($message_id) use($app) {
            global $user_id;

            $db = new DbHandler();
            $response = array();
            $result = $db->deletemessage($user_id, $message_id);
            if ($result) {
